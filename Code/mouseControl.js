...
//Chester Urbati
//Added so the mouse controls to have the zoom controled by the keys. 
//It makes it easier to zoom in and out. 
document.addEventListener("keydown", (event) => {

	const keyBoardName = event.key;

	if(keyBoardName === "+")
	{
		console.log("+");
		viewer.radius -= 0.01 * 10;
